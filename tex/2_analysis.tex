...
\begin{enumerate}
    \item Summarize the project domain description in a form of text or a flow chart. 
    \item Perform the \oact{R}\iact{G}\dact{B} coloring to identify acts. Be vigilant about the \btrap{blue traps}!
...
\begin{itemize}
    ...
    \item \dact{Datalogical Act}
    \item \btrap{Blue Trap}
\end{itemize}
