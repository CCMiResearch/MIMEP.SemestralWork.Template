...
\begin{enumerate}
    \item Find and insert or write the project domain description into this document. The domain should have at least 7 ontological transactions. 
    ...
    \begin{enumerate}
        ...
        \item PSD - Someone should be able to devise a database model from the result. At least 7 entities and 15 fields. 
    \end{enumerate}
